...
#### classed generator basically returns a dataset, we don't need to worry about this crap, just use our bdd dataset trainer and see what happens
class ClassedGenerator:
    """ ClassedGenerator returns images only for the specified classes """
    def __init__(self, preload = "", gpus = 1, i_shape=(128,128), normalization_mean = 0.5,
                 normalization_std = 0.5, normalization_scale = 1./255., h_flip = 0.0, t_crop = False, rea = False, **kwargs):
