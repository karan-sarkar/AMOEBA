...
def make_data_loader(cfg, is_train=True, is_target=False, distributed=False, max_iter=None, start_iter=0):
    ...
    if is_target:
        dataset_list = cfg.DATASETS.TARGET_TRAIN if is_train else cfg.DATASETS.TEST
